...
module.exports.config = {
  ...
  role: 0,
  author: "Amit Max ⚡",
  description: "Generate AI image using Poli1 API",
...
module.exports.onStart = async ({ event, args, api }) => {
  ...
  try {
    ...
    const imgPath = path.join(__dirname, "cache", `poli1_${Date.now()}.png`);
    ...
    writer.on("finish", () => {
      api.sendMessage({
        body: `Here is your AI-generated image for: "${userPrompt}" (4k quality)`,
